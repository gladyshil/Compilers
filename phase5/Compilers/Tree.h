...
/* An increment expression: expr ++ */

class Increment : public Unary {
public:
    unsigned scale;

    Increment(Expression *expr, const Type &type);
    virtual void write(ostream &ostr) const;
};


/* A decrement expression: expr -- */

class Decrement : public Unary {
public:
    unsigned scale;

    Decrement(Expression *expr, const Type &type);
    virtual void write(ostream &ostr) const;
};
...
public:
    unsigned scaleResult, scaleRight;
